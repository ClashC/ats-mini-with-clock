...
* **Brightness** - Display brightness level (0...255). The minimal one draws about 80mA of the battery power, the default one about 100mA, the max level about 120mA.
...
* **Alarm 1** - Wake time for the first alarm. Press the encoder to switch between minutes, hours, and the On/Off flag. The active value blinks at a 75/25 duty cycle while being edited and can be adjusted with the knob.
